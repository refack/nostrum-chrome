...
(function (b) {
    ...
    b.extend(b.jgrid, {
        version: "4.4.1",
        htmlDecode: function (b) {return b && ("&nbsp;" == b || "&#160;" == b || 1 === b.length && 160 === b.charCodeAt(0)) ? "" : !b ? b : ("" + b).replace(/&gt;/g, ">").replace(/&lt;/g, "<").replace(/&quot;/g, '"').replace(/&amp;/g, "&")},
        htmlEncode: function (b) {return !b ? b : ("" + b).replace(/&/g, "&amp;").replace(/\"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;")},
        format: function (f) {
        ...
        stringToDoc: function (b) {
            ...
            try {e = (new DOMParser).parseFromString(b, "text/xml")} catch (c) {e = new ActiveXObject("Microsoft.XMLDOM"), e.async = !1, e.loadXML(b)}
        ...
        guid: 1,
        uidPref: "jqg",
        randId: function (f) {return (f ? f : b.jgrid.uidPref) + b.jgrid.guid++},
        getAccessor: function (b, e) {
            var c, d, a = [], g;
            if ("function" === typeof e)return e(b);
            c = b[e];
            if (void 0 === c)try {if ("string" === typeof e && (a = e.split(".")), g = a.length)for (c = b; c && g--;)d = a.shift(), c = c[d]} catch (h) {}
            return c
        },
        ...
        from: function (f) {
            return new function (e, c) {
                ...
                this._funcLoop = function (d) {
                    var c = [];
                    b.each(a, function (a, b) {c.push(d(b))});
                    return c
                };
                ...
                this._resetNegate = function () {o = !1};
                this._repeatCommand = function (a, b) {return null === l ? d : null !== a && null !== b ? l(a, b) : null === k || !u ? l(a) : l(k, a)};
                ...
                this._performSort = function () {0 !== v.length && (a = d._doSort(a, 0))};
                ...
                this._getOrder = function (a, c, f, g, e) {
                    ...
                    m = "float" == g || "number" == g || "currency" == g || "numeric" == g ? function (a) {
                        ...
                        return isNaN(a) ? 0 : a
                    } : "int" == g || "integer" == g ? function (a) {return a ? parseFloat(("" + a).replace(j, "")) : 0} : "date" ==
                    g || "datetime" == g ? function (a) {return b.jgrid.parseDate(e, a).getTime()} : b.isFunction(g) ? g : function (a) {
                        a || (a = "");
                ...
                this.execute = function () {
                    var c = i, g = [];
                    if (null === c)return d;
                    b.each(a, function () {eval(c) && g.push(this)});
                    a = g;
                    return d
                };
                ...
                this.select = function (c) {
                    ...
                    if (b.isFunction(c)) {
                        var g = [];
                        b.each(a, function (a, b) {g.push(c(b))});
                        return g
                    }
                    return a
                };
                ...
                this.isNull = function (a, b, c) {return d._compareValues(d.equals, a, null, "===", c)};
                ...
                this.startsWith = function (a, c) {
                    var g = void 0 === c || null === c ? a : c, g = f ? b.trim(g.toString()).length :
                        g.toString().length;
                    u ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + g + ") == " + d._getStr('"' + d._toStr(c) + '"')) : (g = f ? b.trim(c.toString()).length : c.toString().length, d
                    .
                    _append(d._getStr("this") + ".substr(0," + g + ") == " + d._getStr('"' + d._toStr(a) + '"'))
                    )
                    ;
                ...
                this.groupBy = function (b, c, g, f) {return !d._hasData() ? null : d._getGroup(a, b, c, g, f)};
                ...
                var d = b.extend(!0, {
                    ...
                    dragEnd: function () {
                        ...
                        if (this.resizing) {
                            ...
                            !0 === d.forceFit ? (e = this.headers[c + d.nv].newWidth || this.headers[c + d.nv].width,this.headers[c + d.nv].width = e, this.headers[c + d.nv].el.style.width = e + "px", this.cols[c + d.nv].style.width =
                                e + "px", 0 < this.footers.length && (this.footers[c + d.nv].style.width = e + "px"), d.colModel[c + d.nv].width = e
                        ):
                            (d.tblwidth = this.newWidth || d.tblwidth, b("table:first", this.bDiv).css("width", d.tblwidth + "px"), b("table:first", this.hDiv).css("width", d.tblwidth + "px"), this.hDiv.scrollLeft = this.bDiv.scrollLeft, d.footerrow && (b("table:first", this.sDiv).css("width", d.tblwidth + "px"), this.sDiv.scrollLeft = this.bDiv.scrollLeft));
                    ...
                    populateVisible: function () {
                        ...
                        if (a) {
                            ...
                            if (e[0].rows.length)try {I = (f = e[0].rows[1]) ? b(f).outerHeight() || c.prevRowHeight : c.prevRowHeight} catch (h) {I = c.prevRowHeight}
                            if (I) {
                                c.prevRowHeight = I;
                                var i = d.rowNum;
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        ...
                        var o = function (a, b) {
                            ...
                            U = function (c) {
                                ...
                                if (!d || !d.length)d = b.map(a.p.colModel, function (a, b) {return b});
                                c && (d = b.map(d, function (a) {return a < c ? null : a - c}));
                                return d
                            }, M = function (a, c) {
                                var d;
                            ...
                            Z = function (c, d, e, f, g) {
                                ...
                                if (b.isXMLDoc(c)) {
                                    ...
                                    k = (o + "").indexOf("[") === -1 ? p.length ? function (a, c) {return b(o, a).text() || c} : function (a, c) {return b(j.cell, a).eq(o).text() || c} : function (a, b) {return a.getAttribute(o.replace(/[\[\]]/g, "")) || b};
                                    a.p.userData = {};
                                    ...
                                    b.isFunction(j.userdata) ? a.p.userData = j.userdata.call(a, c) || {} : b.jgrid.getXmlData(c, j.userdata, true).each(function () {a.p.userData[this.getAttribute("name")] = b(this).text()});
                                    ...
                                    if (a.p.subGrid === true)try {b(a).jqGrid("addSubGrid", s + m)} catch (P) {}
                                    a.p.totaltime = new Date - h;
                                    if (r > 0 && a.p.records === 0)a.p.records = t;
                                    C = null;
                                    if (a.p.treeGrid === true)try {b(a).jqGrid("setTreeNode", B + 1, r + B + 1)} catch (Q) {}
                                ...
                                if (c) {
                                    ...
                                    if (a.p.treeGrid === true)try {b(a).jqGrid("setTreeNode", v + 1, k + v + 1)} catch (Q) {}
                                    if (!a.p.treeGrid && !a.p.scroll)a.grid.bDiv.scrollTop = 0;
                                    a.p.reccount = k;
                                    a.p.treeANode = -1;
                                ...
                                function c(d) {
                                    ...
                                    if (d.groups !== void 0) {
                                        ...
                                        for (g = 0; g < d.groups.length; g++) {
                                            e > 0 && h && s.or();
                                            try {c(d.groups[g])} catch (k) {alert(k)}
                                            e++
                                        }
                                        h &&
                                        s.orEnd()
                                ...
                                if (b.isArray(a.p.data)) {
                                    ...
                                    if (a.p.treeGrid)b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype, f[d].srcfmt); else {
                                        var o = {
                                            ...
                                            nc: function (a, b) {return b === "OR" ? a.orNot().contains : a.andNot().contains},
                                            bw: function (a) {return a.startsWith},
                                            bn: function (a, b) {return b === "OR" ? a.orNot().startsWith : a.andNot().startsWith},
                                            en: function (a, b) {return b === "OR" ? a.orNot().endsWith : a.andNot().endsWith},
                                            ew: function (a) {return a.endsWith},
                                            ni: function (a, b) {return b === "OR" ? a.orNot().equals : a.andNot().equals},
                                        ...
                                        if (a.p.search === true) {
                                            ...
                                            if (n) {
                                                ...
                                                c(n)
                                            } else try {s = o[a.p.postData.searchOper](s)(a.p.postData.searchField, a.p.postData.searchString, f[a.p.postData.searchField])} catch (p) {}
                                        }
                                ...
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        for (l = 0; l < k.groupField.length; l++) {
                                            ...
                                            b.each(a.p.colModel, function (a, b) {if (b.name == r && b.index)r = b.index});
                        ...
                        l = function (c, e) {
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                b("#first" + b.jgrid.jqID(e) + ", #prev" + b.jgrid.jqID(e) + ", #next" + b.jgrid.jqID(e) + ", #last" + b.jgrid.jqID(e)).click(function () {
                                    ...
                                    if (c === 0 || c === 1)i = h = g = f = false; else if (c > 1 && b >= 1)if (b === 1)g = f = false; else {if (b === c)i = h = false} else if (c >
                                        1 && b === 0) {
                                        i = h = false;
                                        b = c - 1
                                    }
                        ...
                        var ia = function (c,
                            ...
                            if (a.p.colModel[e].sortable && !(a.p.savedRow.length > 0)) {
                                if (!d) {
                                    if (a.p.lastsort == e)if (a.p.sortorder == "asc")a.p.sortorder = "desc"; else {if (a.p.sortorder == "desc")a.p.sortorder = "asc"} else a.p.sortorder = a.p.colModel[e].firstsortorder || "asc";
                                    a.p.page = 1
                                }
                                if (f) {
                        ...
                        if (!0 === this.p.treeGrid) {
                            try {b(this).jqGrid("setTreeGrid")} catch (pa) {}
                            "local" != a.p.datatype && (a.p.localReader = {id: "_id_"})
                        }
                        if (this.p.subGrid)try {b(a).jqGrid("setSubGrid")} catch (qa) {}
                        ...
                        if (a.p.sortable &&
                            b.fn.sortable)try {b(a).jqGrid("sortableColumns", j)} catch (ra) {}
                        ...
                        b(a).before(c.hDiv).click(function (c) {
                            ...
                            if (!(A.tagName == "A" || (A.tagName == "INPUT" || A.tagName == "TEXTAREA" || A.tagName == "OPTION" || A.tagName == "SELECT") && !d) && e === true) {
                                ...
                                if (a.p.cellEdit === true)if (a.p.multiselect && d)b(a).jqGrid("setSelection", t, true, c); else {
                                    t = n[0].rowIndex;
                                    try {b(a).jqGrid("editCell", t, H, true)} catch (f) {}
                        ...
                        k ? (2 == b("tbody", this).length && b("tbody:gt(0)", this).remove(), a.p.multikey && b(c.bDiv).bind("selectstart", function () {return false})) : a.p.multikey && b(c.bDiv).bind("mousedown", function () {return false});
                        D && b(c.bDiv).hide();
                        c.cDiv = document.createElement("div");
                        var ha = !0 === a.p.hidegrid ? b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function () {ha.addClass("ui-state-hover")},
                            function () {ha.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl" == i ? "left" : "right", "0px") : "";
                        ...
                        b(".ui-jqgrid-labels", c.hDiv).bind("selectstart", function () {return false});
                        ...
                        a.updatepager = function (c, d) {
                            ...
                            c === true && a.p.rownumbers === true && b("td.jqgrid-rownum", a.rows).each(function (a) {b(this).html(g + 1 + a)});
                        ...
                        a.constructTr = N;
                        a.formatter = function (a, b, c, d, e) {return u(a, b, c, d, e)};
                        b.extend(c, {
                            populate: G,
                            emptyRows: M
                        });
                        this.grid = c;
                        a.addXmlData = function (b) {Z(b, a.grid.bDiv)};
                        a.addJSONData = function (b) {$(b, a.grid.bDiv)};
    ...
    b.jgrid.extend({
        ...
        setGridParam: function (f) {return this.each(function () {this.grid && "object" === typeof f && b.extend(!0, this.p, f)})},
        getDataIDs: function () {
            var f = [], e = 0, c, d = 0;
            this.each(function () {
        ...
        getRowData: function (f) {
            ...
            this.each(function () {
                ...
                for (; g < a;)d && (j = h.rows[g]), b(j).hasClass("jqgrow") && (b('td[role="gridcell"]', j).each(function (a) {
                    ...
                    } catch (c) {e[i] = b.jgrid.htmlDecode(b(this).html())}
                }), d && (c.push(e), e = {})), g++
            });
            return c ? c : e
        },
        delRowData: function (f) {
            ...
            this.each(function () {
                ...
                if (!0 === this.p.altRows && e) {
                    ...
                    b(this.rows).each(function (a) {1 == a % 2 ? b(this).addClass(g) : b(this).removeClass(g)})
                }
            });
            return e
        },
        ...
        addRowData: function (f, e, c, d) {
            ...
            e && (b.isArray(e) ? (v = !0, c = "last", u = f):(e = [e], v = !1), this.each(function () {
                ...
                for (var M = 0, Q = "", N = {}, Z = b.isFunction(this.p.afterInsertRow) ? true : false; M < U;) {
                    ...
                    h = [];
                    if (v) {
                        try {f = E[u]} catch ($) {f = b.jgrid.randId()}
                ...
                this.p.altRows === true && !v && (c == "last" ? (this.rows.length - 1) % 2 == 1 && b(this.rows[this.rows.length - 1]).addClass(L) :
                    b(this.rows).each(function (a) {a % 2 == 1 ? b(this).addClass(L) : b(this).removeClass(L)}));
                ...
                if (c.grid) {
                    ...
                    b(this.p.colModel).each(function (i) {
                        if (-1 !== b.inArray(this.name, f) && this.hidden === h) {
                            ...
                            b("tr", c.grid.hDiv).each(function () {b(this.cells[i]).css("display", e)});
                            b(c.rows).each(function () {b(this).hasClass("jqgroup") || b(this.cells[i]).css("display", e)});
        ...
        remapColumns: function (f, e, c) {
            function d(a) {
                ...
                c = a.length ? b.makeArray(a) : b.extend({},
                    a);
                b.each(f, function (b) {a[b] = c[this]})
            }
                ...
                if (this.grid) {
                    ...
                    if (!isNaN(f)) {
                        ...
                        if (!0 === e) {
                            ...
                            c.p.tblwidth > f ? (j = c.p.tblwidth - parseInt(f, 10), c
                        .
                            p.tblwidth = f, d = c.p.colModel[h].width -= j
                        ):
                            d = c.p.colModel[h].width;
        ...
        setLabel: function (f, e, c, d) {
            return this.each(function () {
                var a = -1;
                if (this.grid && "undefined" != typeof f && (b(this.p.colModel).each(function (b) {if (this.name == f)return a = b, !1}), 0 <= a)) {
        ...
        setCell: function (f, e, c, d, a, g) {
            return this.each(function () {
                var h = -1, i, j;
                if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function (a) {if (this.name == e)return h = a, !1}) : h = parseInt(e, 10), 0 <= h && (i = this.rows.namedItem(f)))) {
                    var l = b("td:eq(" + h + ")", i);
        ...
        getCell: function (f, e) {
            ...
            this.each(function () {
                var d = -1;
                if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function (a) {if (this.name === e)return d = a, !1}) : d = parseInt(e, 10), 0 <= d)) {
        ...
        getCol: function (f, e, c) {
            ...
            this.each(function () {
                var l = -1;
                if (this.grid && (isNaN(f) ? b(this.p.colModel).each(function (a) {if (this.name === f)return l = a, !1}) : l = parseInt(f, 10), 0 <= l)) {
                    ...
                    if (k && 0 < k) {
                        for (; m < k;) {
                            if (b(this.rows[m]).hasClass("jqgrow")) {
                                ...
                                } catch (o) {a = b.jgrid.htmlDecode(this.rows[m].cells[l].innerHTML)}
                                c ? (j = parseFloat(a), g+= j, void 0 === i && (i = h = j), h = Math.min(h, j), i = Math.max(i, j)
                            ):
                                e ? d.push({id: this.rows[m].id, value: a}) : d.push(a)
                            }
                            m++
                        }
        ...
        getLocalRow: function (b) {
            var e = !1, c;
            this.each(function () {"undefined" !== typeof b && (c = this.p._index[b], 0 <= c && (e = this.p.data[c]))});
            return e
        }
    })
})(jQuery);
(function (c) {
    ...
    c.extend(c.fmatter, {
        ...
        isObject: function (a) {return a && ("object" === typeof a || c.isFunction(a)) || !1},
    ...
    c.fn.fmatter = function (a, b, f, d, e) {
        ...
        try {g = c.fn.fmatter[a].call(this, b, f, d, e)} catch (h) {}
        return g
    };
    c.fmatter.util = {
        NumberFormat: function (a, b) {
            ...
            var e = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, g = "string" === typeof b ? b.match(e) : null, e = function (a, b) {
                a = "" + a;
    ...
    c.fn.fmatter.defaultFormat = function (a, b) {return c.fmatter.isValue(a) && "" !== a ? a : b.defaultValue ? b.defaultValue : "&#160;"};
    c.fn.fmatter.email = function (a, b) {return c.fmatter.isEmpty(a) ? c.fn.fmatter.defaultFormat(a, b) : '<a href="mailto:' + a + '">' + a + "</a>"};
    ...
    c.fn.fmatter.select = function (a, b) {
        ...
        if (f) {
            ...
            h && (i = a.split(","), i = c.map(i, function (a) {return c.trim(a)}));
            if (c.fmatter.isString(f))for (var j = f.split(g), k = 0, l = 0; l < j.length; l++)if (g = j[l].split(e), 2 < g.length && (g[1] = c.map(g, function (a, b) {if (b > 0)return a}).join(e)), h)-1 < c.inArray(g[0], i) && (d[k] = g[1], k++); else {
                if (c.trim(g[0]) == c.trim(a)) {
                    d[0] = g[1];
                    break
                }
            } else c.fmatter.isObject(f) && (h ? d = c.map(i, function (a) {return f[a]}) :
                d[0] = f[a] || "")
        }
        a = d.join(", ");
    ...
    c.fn.fmatter.actions = function (a, b) {
        ...
        c.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + g + "><span class='ui-icon ui-icon-pencil'></span></div>"):f.editbutton
        &&
        (g = "onclick=jQuery.fn.fmatter.rowactions('" + d + "','" + b.gid + "','edit'," + b.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ", e = e + "<div title='" + c.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + g + "><span class='ui-icon ui-icon-pencil'></span></div>");
    ...
    c.unformat.select = function (a, b, f, d) {
        ...
        if (d.value) {
            ...
            d && (h = a.split(","), h = c.map(h, function (a) {return c.trim(a)}));
            if (c.fmatter.isString(g))for (var i = g.split(e), j = 0, k = 0; k < i.length; k++)if (e = i[k].split(b), 2 < e.length && (e[1] = c.map(e, function (a, b) {if (b > 0)return a}).join(b)), d)-1 < c.inArray(e[1], h) && (f[j] = e[0], j++); else {
                ...
                if (!this.ftoolbar) {
                    var e = function () {
                        ...
                        a.each(c.p.colModel, function () {
                            ...
                            if (g = a("#gs_" + a.jgrid.jqID(this.name), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv).val())d[f] = g, h[f] = m, j++; else try {delete c.p.postData[f]} catch (e) {}
                        });
                        var e = 0 < j ? !0 :
                            !1;
                        if (!0 === b.stringResult || "local" == c.p.datatype) {
                            ...
                            a.each(["searchField", "searchString", "searchOper"], function (a, b) {c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]})
                        ...
                        r || a(c).jqGrid("setGridParam", {search: e}).trigger("reloadGrid", [{page: 1}]);
                        ...
                        if (this.search)switch (this.stype) {
                            case "select":
                                if (n = this.surl || f.dataUrl)a.ajax(a.extend({
                                    url: n, dataType: "html", success: function (c) {
                                    ...
                                    i.searchoptions.separator ? ":" : i.searchoptions.separator, k = void 0 === i.searchoptions.delimiter ? ";" : i.searchoptions.delimiter):i.editoptions
                                &&
                    ...
                    this.clearToolbar = function (d) {
                        ...
                        a.each(c.p.colModel, function () {
                            ...
                            switch (this.stype) {
                                case "select":
                                    ...
                                    if (void 0 !== b)j[f] = b, g++; else try {delete c.p.postData[f]} catch (d) {}
                                    break;
                                case "text":
                                    if (a("#gs_" + a.jgrid.jqID(this.name), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv).val(b), void 0 !== b)j[f] = b, g++; else try {delete c.p.postData[f]} catch (e) {}
                            }
                        });
                        var h = 0 < g ? !0 : !1;
                        if (!0 === b.stringResult ||
                        ...
                        l || d && a(c).jqGrid("setGridParam", {search: h}).trigger("reloadGrid", [{page: 1}]);
            ...
            return this.each(function () {
                ...
                if (c) {
                    ...
                    for (e = h.length; c < e; c++) {
                        ...
                        try {g.removeAttr("rowSpan")} catch (f) {g.attr("rowSpan", 1)}
                        d.append(g);
        ...
        setGroupHeaders: function (b) {
            ...
            return this.each(function () {
                ...
                for (d = 0; d < n; d++)if (i = m[d].el, j = a(i), c = f[d], g = {
                    ...
                    g = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                        height: "22px",
                        "border-top": "0px none"
                    }).html(q);
                    ...
                    h.append(i);
                    e -= 1
                } else 0 === e ? b.useColSpanStyle ? j.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                    display: c.hidden ? "none" : "",
                    "border-top": "0px none"
                ...
                a(this).bind("jqGridResizeStop.setGroupHeaders", function (a, b, c) {p.find("th").eq(c).width(b)})
            })
        },
                ...
                if (this.grid) {
                    ...
                    if (!(!0 === b.p.subGrid || !0 === b.p.treeGrid || !0 === b.p.cellEdit || b.p.sortable ||
                        ...
                        if (0 <= h && g) {
                            ...
                            if (b.p.groupHeader) {
                                a("tr.jqg-first-row-header, tr.jqg-third-row-header", d).each(function () {a("th:gt(" + h + ")", this).remove()});
                                var i = -1, j = -1;
                                ...
                                i !== h && (j = h);
                                a("tr.jqg-second-row-header", d).each(function () {a("th:gt(" + j + ")", this).remove()})
                            } else a("tr", d).each(function () {a("th:gt(" + h + ")", this).remove()});
                            a(d).width(1);
                            a(b.grid.fhDiv).append(d).mousemove(function (a) {if (b.grid.resizing)return b.grid.dragMove(a), !1});
                            ...
                            a(b).bind("jqGridAfterGridComplete.setFrozenColumns", function () {
                                ...
                                a("tr", c).each(function () {a("td:gt(" + h + ")", this).remove()});
    ...
    a.extend(a.jgrid, {
        ...
        hideModal: function (d, b) {
            ...
            if (a.fn.jqm && !0 === b.jqm)a(d).attr("aria-hidden", "true").jqmHide(); else {
                if ("" !== b.gb)try {a(".jqgrid-overlay:first", b.gb).hide()} catch (f) {}
        ...
        createModal: function (d, b, c, f, g, h, i) {
            ...
            c.caption + "</span>");
            var n = a("<a href='javascript:void(0)' class='ui-jqdialog-titlebar-close ui-corner-all'></a>").hover(function () {n.addClass("ui-state-hover")}, function () {n.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-closethick'></span>");
            a(k).append(n);
        ...
        info_dialog: function (d, b, c, f) {
            ...
            b += "</div>";
            try {"false" == a("#info_dialog").attr("aria-hidden") && a.jgrid.hideModal("#info_dialog", {jqm: h}), a("#info_dialog").remove()} catch (e) {}
            a.jgrid.createModal({
        ...
        createEl: function (d, b, c, f, g) {
            function h(b, d) {
                ...
                d.dataEvents && a.each(d.dataEvents, function () {void 0 !== this.data ? a(b).bind(this.type, this.data, this.fn) : a(b).bind(this.type, this.fn)});
                return d
            }
            ...
            function i(b, d, c) {
                ...
                a.each(d, function (d,
                                    c) {-1 === a.inArray(d, e) && a(b).attr(d, c)});
            ...
            switch (d) {
                ...
                case "checkbox":
                    ...
                    e.type = "checkbox";
                    b.value ? (d = b.value.split(":"), c
                ===
                    d[0] &&
                    (e.checked = !0, e.defaultChecked = !0), e.value = d[0], a(e).attr("offval", d[1])
                ):
                    (d = c.toLowerCase(),
                    0 > d.search(/(false|0|no|off|undefined)/i) && "" !== d ? (e.checked = !0, e.defaultChecked = !0, e.value = c) : e.value = "on", a(e).attr("offval", "off")
                )
                    ;
                    i(e, b, ["value"]);
                    b = h(e, b);
                ...
                case "select":
                    ...
                    !0 === b.multiple ? (d = !0, e
                .
                    multiple = "multiple", a(e).attr("aria-multiselectable", "true")
                ):
                    d = !1;
                    if ("undefined" != typeof b.dataUrl)a.ajax(a.extend({
                        ...
                        type: "GET", dataType: "html", context: {elem: e, options: b, vl: c}, success: function (d) {
                            ...
                            if (d = a(d).html()) {
                                ...
                                if (g) {
                                    b = e.split(",");
                                    b = a.map(b, function (b) {return a.trim(b)})
                                } else b[0] = a.trim(e);
                                setTimeout(function () {
                        ...
                        d && (f = c.split(","), f = a.map(f, function (b) {return a.trim(b)}));
                        ...
                        if ("string" === typeof b.value) {
                            ...
                            for (j = 0; j < k.length; j++) {
                                n = k[j].split(m);
                                2 < n.length && (n[1] =
                                    a.map(n, function (a, b) {if (b > 0)return a}).join(m));
        ...
        checkTime: function (d) {
            ...
            if (!a.jgrid.isEmpty(d))if (d = d.match(b)) {
                if (d[3]) {if (1 > d[1] || 12 < d[1])return !1} else if (23 < d[1])return !1;
                if (59 < d[2])return !1
            } else return !1;
            return !0
        },
        checkValues: function (d, b, c, f, g) {
            ...
            if ("undefined" === typeof f)if ("string" == typeof b) {
                ...
                for (g = c.p.colModel.length; f < g; f++)if (c.p.colModel[f].name == b) {
                    ...
                    b = f;
                    try {i = c.p.colModel[f].formoptions.label} catch (e) {}
                    break
                }
            } else 0 <=
            ...
            if (h) {
                ...
                if (!0 === h.custom && !(!1 === f && a.jgrid.isEmpty(d)))return a.isFunction(h.custom_func) ? (d = h.custom_func.call(c, d, i), a
            .
                isArray(d) ? d : [!1, a.jgrid.edit.msg.customarray, ""]
            ):
    ...
    a.jgrid.extend({
        searchGrid: function (c) {
                ...
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0])d(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
                        ...
                        a("#" + n + "_search").bind("click", function () {
                            ...
                            if (c.stringResult) {
                                try {h = xmlJsonClass.toJson(f, "", "", false)} catch (g) {try {h = JSON.stringify(f)} catch (j) {}}
                                if (typeof h === "string") {
                                    d[c.sFilter] = h;
                        ...
                        d(a("#" + n));
                        a(".fm-button:not(.ui-state-disabled)", l).hover(function () {a(this).addClass("ui-state-hover")}, function () {a(this).removeClass("ui-state-hover")})
                    }
                }
            })
            ...
            return this.each(function () {
                    ...
                    a(i + " > tbody > tr > td > .FormElement").each(function () {
                        ...
                        if (c.length) {
                                ...
                                if (this.name === d && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (k[d] = this.editoptions.custom_value.call(b, a("#" + a.jgrid.jqID(d), i), "get"),
                                            void 0 === k[d])throw"e1";
                                    } catch (c) {"e1" === c ? a.jgrid.info_dialog(jQuery.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.novalue, jQuery.jgrid.edit.bClose) : a.jgrid.info_dialog(jQuery.jgrid.errors.errcap, c.message, jQuery.jgrid.edit.bClose)}
                                    return !0
                                }
                            })
                        } else {
                            switch (a(this).get(0).type) {
                                case "checkbox":
                                    a(this).is(":checked") ? k[this.name] = a(this).val() : (c = a(this).attr("offval"), k
                                    [
                                    this.name
                                ]
                                    = c
                                ...
                                case "select-multiple":
                                    ...
                                    var e = [];
                                    a("option:selected", this).each(function (b, c) {e[b] = a(c).text()});
                                    B[this.name] = e.join(",");
                                    break;
                                case "password":
                                case "text":
                ...
                function r(d, e, h) {
                    ...
                    if ("_empty" == d)a(o).each(function () {
                        ...
                        if ((m = a("#" + a.jgrid.jqID(f), "#" + h)) && m.length && null !== m[0])if (q = "", j.defaultValue ?
                                (q = a.isFunction(j.defaultValue) ? j.defaultValue.call(b) : j.defaultValue,"checkbox" == m[0].type ? (l = q.toLowerCase(),0 > l.search(/(false|0|no|off|undefined)/i) && "" !== l ? (m[0].checked = !0, m[0].defaultChecked = !0, m[0].value = q) : (m[0].checked = !1, m[0].defaultChecked = !1)):
                        m.val(q)
                        ):
                        "checkbox" == m[0].type ? (m[0].checked = !1, m[0].defaultChecked = !1, q = a(m).attr("offval")) : m[0].type && "select" == m[0].type.substr(0, 6) ? m[0].selectedIndex = 0 : m.val(q), !0 === c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate
                        )
                        c[b.p.id]._savedData[f] =
                            q
                    }), a("#id_g", "#" + h).val(d); else {
                        ...
                        n && (a('td[role="gridcell"]', n).each(function (m) {
                            ...
                            if ("cb" !== f && "subgrid" !== f && "rn" !== f && !0 === o[m].editable) {
                                ...
                                } catch (i) {g = "textarea" == o[m].edittype ? a(this).text() : a(this).html()}
                                ...
                                switch (o[m].edittype) {
                                    ...
                                    case "textarea":
                                        ...
                                        break;
                                    case "select":
                                        var j = g.split(","), j = a.map(j, function (b) {return a.trim(b)});
                                    ...
                                    case "checkbox":
                                        g += "";
                                        o[m].editoptions && o[m].editoptions.value ? o[m].editoptions.value.split(":")[0] == g ? (a("#" + f, "#" + h)[b.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + f, "#" + h)[b.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + f, "#" + h)[b.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + f, "#" + h)[b.p.useProp ? "prop" : "attr"]("defaultChecked", !1)) : (g = g.toLowerCase(),
                                        0 > g.search(/(false|0|no|off|undefined)/i) && "" !== g ? (a("#" + f, "#" + h)[b.p.useProp ?
                                        ...
                                        break;
                                    case "custom":
                                        try {if (o[m].editoptions && a.isFunction(o[m].editoptions.custom_value))o[m].editoptions.custom_value.call(b, a("#" + f, "#" + h), "set", g); else throw"e1";} catch (q) {
                ...
                function u() {a.each(b.p.colModel, function (a, b) {b.editoptions && !0 === b.editoptions.NullIfEmpty && k.hasOwnProperty(b.name) && "" === k[b.name] && (k[b.name] = "null")})}
                        ...
                        v = a.extend({
                            ...
                            complete: function (m, l) {
                                ...
                                if (f[0] === false) {
                                    ...
                                    a.each(b.p.colModel, function () {if (B[this.name] && this.formatter && this.formatter == "select")try {delete B[this.name]} catch (a) {}});
                                    k = a.extend(k, B);
                                    b.p.autoencode &&
                                    a.each(k, function (b, d) {k[b] = a.jgrid.htmlDecode(d)});
                                    if (k[o] == g.addoper) {
                                        ...
                                        if (c[b.p.id].reloadAfterSubmit) {
                                            ...
                                            c[b.p.id].closeAfterEdit || setTimeout(function () {a(b).jqGrid("setSelection", k[j])}, 1E3)
                                ...
                                try {a(":input:visible", "#" + h)[0].focus()} catch (p) {}
                            }
                ...
                if (b.grid && o) {
                    ...
                    "new" === o ? (o = "_empty", z = "add", d
                .
                    caption = c[b.p.id].addCaption
                ):
                    (d.caption = c[b.p.id].editCaption, z = "edit");
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                        ...
                        d.bExit + "</a>", j = d.zIndex || 999, j++, a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:" + j + ";display:none;'>&#160;" + (a.browser.msie && 6 == a.browser.version ? '<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>' : "") + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (j + 1) + "'>" + d.saveData + "<br/><br/>" + J + D + K + "</div>").insertAfter("#" + h), a("#sNew", "#" + a.jgrid.jqID(q.themodal)).click(function () {
                            ...
                            a(".confirm", "#" + a.jgrid.jqID(q.themodal)).hide();
                            a("#" + h).data("disabled", false);
                            setTimeout(function () {a(":input", "#" + h)[0].focus()}, 0);
                            return false
                        ...
                        a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {
                            gbox: "#gbox_" + a.jgrid.jqID(s), jqm: d.jqModal,
            ...
            c[a(this)[0].p.id] = d;
            return this.each(function () {
                function e() {(!0 === c[l.p.id].closeOnEscape || !0 === c[l.p.id].navkeys[0]) && setTimeout(function () {a(".ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(s.modalhead)).focus()}, 0)}
                ...
                function n(b, c, e, f) {
                    ...
                    a(c.p.colModel).each(function (b) {
                        ...
                        if ("cb" !== g && "subgrid" !== g && "rn" !== g && w) {
                            ...
                            a("td:eq(" + (p - 2) + ")", j[0]).html("<b>" + ("undefined" === typeof d.label ? c.p.colNames[b] : d.label) + "</b>");
                ...
                if (l.grid && o) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(s.themodal))[0]) {
                        ...
                        if (0 < q) {
                            var x = [];
                            a.each(a(A)[0].rows, function (a, b) {x[a] = b});
                            x.sort(function (a, b) {return a.rp > b.rp ? 1 : a.rp < b.rp ? -1 : 0});
                            a.each(x, function (b, c) {a("tbody", A).append(c)})
                        }
                        ...
                        a(".fm-button:not(.ui-state-disabled)", "#" + p + "_2").hover(function () {a(this).addClass("ui-state-hover")},
            ...
            return this.each(function () {
                ...
                if (e.grid && o) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(j.themodal))[0]) {
                        ...
                        u && (g = u.call(e, a("#" + f)), "undefined" == typeof g && (g = !0));
                        if (!1 === g)return;
                        a(".fm-button", "#" + f + "_2").hover(function () {a(this).addClass("ui-state-hover")},
                            function () {a(this).removeClass("ui-state-hover")});
                                    ...
                                    complete: function (b, i) {
                                        ...
                                        if (g[0] === false) {
                                            ...
                                            if (c[e.p.id].reloadAfterSubmit && e.p.datatype != "local")a(e).trigger("reloadGrid"); else {
                                                if (e.p.treeGrid === true)try {a(e).jqGrid("delTreeNode", e.p.idPrefix + h[0])} catch (o) {} else for (var l = 0; l < h.length; l++)a(e).jqGrid("delRowData", e.p.idPrefix + h[l]);
                                                e.p.selrow = null;
                                                e.p.selarrrow = []
                                            }
                    ...
                    !0 === c[e.p.id].closeOnEscape && setTimeout(function () {a(".ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(j.modalhead)).focus()}, 0)
                }
            })
                    ...
                    if (g.grid && "string" == typeof c) {
                        ...
                        ==
                            ...
                            d.search && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), u = u || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.searchtitle || "", id: u.id || "search_" +
                                h
                            }).click(function () {
                                a(this).hasClass("ui-state-disabled") || (a.isFunction(d.searchfunc) ? d.searchfunc.call(g, u) : a(g).jqGrid("searchGrid", u));
                                return false
                            }).hover(function () {a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")}, function () {a(this).removeClass("ui-state-hover")}), u.showOnLoad && !0 === u.showOnLoad && a(f, b).click(), f = null);
            ...
            return this.each(function () {
                ...
                if (e.grid) {
                    ...
                    if (n)for (var r in n)a("[name=" + a.jgrid.jqID(r) + "]", d).is("input:radio") || a("[name=" + a.jgrid.jqID(r) + "]", d).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(r) + "]", d).each(function () {if (a(this).val() == n[r])a(this)[e.p.useProp ? "prop" : "attr"]("checked", !0); else a(this)[e.p.useProp ? "prop" : "attr"]("checked", !1)}) : a("[name=" + a.jgrid.jqID(r) +
                    "]", d).val(n[r])
                }
            })
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    a.each(r, function (a, c) {u[c.name] = c.value});
...
(function (a) {
                ...
                if (n) {
                    ...
                    this.createTableRowForRule = function (g, d) {
                        ...
                        n.bind("change", function () {
                            ...
                            if (i) {
                                ...
                                var d = "", k = 0;
                                q = [];
                                a.each(b.p.ops, function () {q.push(this.name)});
                    ...
                    this.getStringForGroup = function (a) {
                        ...
                        if (void 0 !== a.groups)for (b = 0; b < a.groups.length; b++) {
                            ...
                            try {d += this.getStringForGroup(a.groups[b])} catch (c) {alert(c)}
                        }
                        if (void 0 !== a.rules)try {for (b = 0; b < a.rules.length; b++)1 < d.length && (d += " " + a.groupOp + " "), d += this.getStringForRule(a.rules[b])} catch (e) {alert(e)}
                        d += ")";
                        return "()" === d ? "" : d
                    };
    ...
    a.extend(a.fn.jqFilter, {
        ...
        filterData: function () {
            var a;
            this.each(function () {a = this.p.filter});
            return a
        },
    ...
    a.jgrid.extend({
        editRow: function (c, d, b, k, g, l, p, h, e) {
            ...
            return this.each(function () {
                ...
                e.grid && (m = a(e).jqGrid("getInd", c, !0), !1 !== m && (f = a(m).attr("editable") || "0", "0" == f && !a(m).hasClass("not-editable-row") && (n = e.p.colModel, a('td[role="gridcell"]', m).each(function (f) {
                    ...
                    } catch (m) {b = n[f].edittype && "textarea" == n[f].edittype ? a(this).text() : a(this).html()}
                    ...
                    if (27 === f.keyCode) {
                        ...
                        if (e.p._inlinenav)try {a(e).jqGrid("showAddEditButtons")} catch (b) {}
                        return !1
                    }
                    if (13 === f.keyCode) {
                        if ("TEXTAREA" == f.target.tagName)return !0;
                        if (a(e).jqGrid("saveRow", c, j) && e.p._inlinenav)try {a(e).jqGrid("showAddEditButtons")} catch (d) {}
                        return !1
                    }
        ...
        saveRow: function (c, d, b, k, g, l, p) {
            ...
            if ("1" === h) {
                        ...
                        switch (m.edittype) {
                            ...
                            case "select":
                                if (m.editoptions.multiple) {
                                    ...
                                    i[o] = a(b).val();
                                    i[o] = i[o] ? i[o].join(",") : "";
                                    a("select option:selected", this).each(function (e, f) {d[e] = a(f).text()});
                                    u[o] = d.join(",")
                                } else i[o] = a("select option:selected", this).val(), u[o] = a("select option:selected", this).text();
                                m.formatter && "select" == m.formatter && (u = {});
                                break;
                            case "custom":
                                try {if (m.editoptions && a.isFunction(m.editoptions.custom_value)) {if (i[o] = m.editoptions.custom_value.call(f, a(".customelement", this), "get"), void 0 === i[o])throw"e2";} else throw"e1";} catch (g) {
                                    "e1" ==
                ...
                if ("clientArray" == e.url) {
                    i = a.extend({}, i, u);
                    f.p.autoencode && a.each(i, function (e, f) {i[e] = a.jgrid.htmlDecode(f)});
                    ...
                    url: e.url, data: a.isFunction(f.p.serializeRowData) ? f.p.serializeRowData.call(f,
                        ...
                        if (d === "success") {
                            ...
                            if (g === true) {
                                f.p.autoencode && a.each(i, function (b, e) {i[b] = a.jgrid.htmlDecode(e)});
                                i = a.extend({}, i, u);
                        ...
                        if (a.isFunction(e.errorfunc))e.errorfunc.call(f, c, b, d, g); else {
                            ...
                            try {a.jgrid.info_dialog(a.jgrid.errors.errcap, '<div class="ui-state-error">' + b + "</div>", a.jgrid.edit.bClose, {buttonalign: "right"})} catch (h) {alert(b)}
                        }
                        e.restoreAfterError === true && a(f).jqGrid("restoreRow", c, e.afterrestorefunc)
                    }
            ...
            return this.each(function () {
                ...
                if (b.grid) {
                    ...
                    if (p !== false) {
                        ...
                        if (d >= 0) {
                            if (a.isFunction(a.fn.datepicker))try {a("input.hasDatepicker", "#" + a.jgrid.jqID(p.id)).datepicker("hide")} catch (j) {}
                            a.each(b.p.colModel, function () {this.editable === true && this.name in b.p.savedRow[d] && (h[this.name] = b.p.savedRow[d][this.name])});
                            a(b).jqGrid("setRowData",
                                c, h);
                            a(p).attr("editable", "0").unbind("keydown");
                            b.p.savedRow.splice(d, 1);
                            a("#" + a.jgrid.jqID(c), "#" + a.jgrid.jqID(b.p.id)).hasClass("jqgrid-new-row") && setTimeout(function () {a(b).jqGrid("delRowData", c)}, 0)
                        }
        ...
        inlineNav: function (c, d) {
            d = a.extend({
                ...
                addParams: {useFormatter: !1, rowID: "new_row"},
                editParams: {},
        ...
        editCell: function (d, f, a) {
            return this.each(function () {
                ...
                if (c.grid && !0 === c.p.cellEdit) {
                    ...
                    } else window.setTimeout(function () {b("#" + b.jgrid.jqID(c.p.knv)).attr("tabindex", "-1").focus()}, 0);
                    i = c.p.colModel[f];
                    g = i.name;
                    if (!("subgrid" == g || "cb" == g || "rn" == g)) {
                        ...
                        if (!0 === i.editable && !0 === a && !h.hasClass("not-editable-cell")) {
                            ...
                            } catch (k) {e = i.edittype && "textarea" == i.edittype ? b(h).text() : b(h).html()}
                            c.p.autoencode &&
                            ...
                            case "select":
                                if (i.editoptions.multiple) {
                                    var j =
                                        b("#" + d + "_" + j, a.rows[d]), n = [];
                                    (e = b(j).val()) ? e.join(",") : e = "";
                                    b("option:selected", j).each(function (a, c) {n[a] = b(c).text()});
                                    h = n.join(",")
                ...
                a.grid && !0 === a.p.cellEdit && b(a.rows).each(function (g) {
                    ...
                    b(this).hasClass("edited") && (b("td", this).each(function (f) {
                        ...
                        if ("cb" !== c && "subgrid" !== c)if ("dirty" == d) {
                            ...
                            } catch (i) {e[c] = b.jgrid.htmlDecode(b(this).html())}
                        } else try {
                            e[c] = b.unformat.call(a, this, {
                                rowId: a.rows[g].id,
                                colModel: a.p.colModel[f]
...
(function (b) {
    ...
    b.fn.jqmAddClose = function (a) {return n(this, a, "jqmHide")};
    b.fn.jqmAddTrigger =
        function (a) {return n(this, a, "jqmShow")};
    b.fn.jqmShow = function (a) {return this.each(function () {b.jqm.open(this._jqm, a)})};
    b.fn.jqmHide = function (a) {return this.each(function () {b.jqm.close(this._jqm, a)})};
    b.jqm = {
        hash: {}, open: function (a, k) {
            ...
            c.a = !0;
            c.w.css("z-index", h);
            e.modal ? (j[0] || setTimeout(function () {o("bind")},
            ...
            e.ajax ? (h = e.target || c.w, f = e.ajax, h = "string" == typeof h ? b(h, c.w) : b(h), f = "@" == f.substr(0, 1) ? b(k).attr(f.substring(1)) : f, h
            .
            html(e.ajaxText).load(f,
                function () {
    ...
    var g = 0, i = b.jqm.hash, j = [], p = b.browser.msie &&
        ...
        r(a)
    }, r = function (a) {try {b(":input:visible", a.w)[0].focus()} catch (d) {}}, o = function (a) {b(document)[a]("keypress", m)[a]("keydown", m)[a]("mousedown", m)}, m = function (a) {
...
(function (b) {
    ...
    b.jqDnR = {
        ...
        stop: function () {b(document).unbind("mousemove", c.drag).unbind("mouseup", c.stop)}
    };
    var c = b.jqDnR, d = c.dnr, e = c.e, g, f, h = function (a,
        ...
        return a.each(function () {
            ...
            c.bind("mousedown", {e: a, k: h}, function (a) {
                ...
                e = c.e;
                g = l ? b(l) : !1;
                if ("relative" != e.css("position"))try {e.position(i)} catch (h) {}
                d = {
                    X: i.left || j("left") || 0,
                    Y: i.top || j("top") || 0,
                ...
                if (b("input.hasDatepicker",
                        e[0])[0])try {b("input.hasDatepicker", e[0]).datepicker("hide")} catch (m) {}
                ...
                if (a.grid) {
                    var m =
                        ...
                        " " + n.row, c).each(function () {
                            ...
                            if (!0 === n.repeatitems)b(n.cell, this).each(function (a) {m(i, b(this).text() || "&#160;", a)}); else {
                        ...
                        if (!a.grid.hDiv.loading)switch (a.grid.hDiv.loading = !0, b("#load_" + b.jgrid.jqID(a.p.id)).show(), a.p.subgridtype || (a.p.subgridtype = a.p.datatype), b.isFunction(a.p.subgridtype) ? a.p.subgridtype.call(a, d) : a.p.subgridtype = a.p.subgridtype.toLowerCase(), a.p.subgridtype) {
                            ...
                            case "json":
                                b.ajax(b.extend({
                                    ...
                                    complete: function (c) {a.p.subgridtype === "xml" ? l(c.responseXML, e) : p(b.jgrid.parse(c.responseText), e)}
                                }, b.jgrid.ajaxOptions, a.p.ajaxSubgridOptions || {}))
                        }
                        return !1
                    }, d, k, q, r = 0, g, j;
                    b.each(a.p.colModel, function () {(!0 === this.hidden || "rn" === this.name || "cb" === this.name) && r++});
                    ...
                    a.subGridXml = function (a, b) {l(a, b)};
                    a.subGridJson = function (a, b) {p(a, b)}
                }
            })
        },
        ...
        groupingSetup: function () {
            ...
            this.each(function () {
                for (var d = this.p.groupingView, h = this, g = d.groupField.length, k, j, p = 0, i = 0; i < g; i++)k = d.groupField[i], j = f[k], void 0 !== j && (0 === e ?
                    ...
                    cnt: 1, pos: d.groups.length -
                    1, summary: b.extend(!0, [], d.summary)
                }) : (d.counters[i].cnt += 1, d.groups[d.counters[i].pos].cnt = d.counters[i].cnt), b.each(d.counters[i].summary, function () {this.v = b.isFunction(this.st) ? this.st.call(h, this.v, this.nm, f) : b(h).jqGrid("groupingCalculations.handler", this.st, this.v, this.nm, this.sr, this.srt, f)}), d.groups[d.counters[i].pos].summary = d.counters[i].summary);
                c.push(a)
            });
            return c
            ...
            this.each(function () {
                ...
                if (k.hasClass(d)) {
                    if (c.showSummaryOnHide) {if (g)for (; g && !(b(g).hasClass("jqfoot") && parseInt(b(g).attr("jqfootlevel"), 10) <= e);)b(g).hide(), g = g.nextSibling} else if (g)for (; g && !b(g).hasClass(f + "_" + ("" + e)) && !b(g).hasClass(f + "_" + ("" + (e - 1)));)b(g).hide(), g = g.nextSibling;
            ...
            return this.each(function () {
                ...
                b.each(d.groups, function (r, l) {
                    ...
                    k + "');return false;\"></span>";
                    try {i = e.formatter(k, l.value, w[l.idx], l.value)} catch (C) {i = l.value}
                            ...
                            for (var o = f(r, m, d.groups), u = e.p.colModel, v, z = o.cnt, n = 0; n < c; n++) {
                                ...
                                b.each(o.summary, function () {
                                    if (this.nm === u[n].name) {
                                        ...
                                        (this.v && 0 < z) && (this.v /= z);
                                        try {v = e.formatter("", this.v, n, this)} catch (a) {v = this.v}
            ...
            handler: function (a, c, b, e, d, h) {
                var g = {
                    sum: function () {return parseFloat(c || 0) + parseFloat(h[b] || 0)},
                    min: function () {return "" === c ? parseFloat(h[b] || 0) : Math.min(parseFloat(c), parseFloat(h[b] || 0))},
                    max: function () {
...
(function (d) {
    d.jgrid.extend({
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid)switch (c.p.treeGridModel) {
                    ...
                    case "adjacency":
                        ...
                        d(c.p.data).each(function () {(null === this[e] || "null" == ("" + this[e]).toLowerCase()) && a.push(this)})
                }
            });
            return a
        },
            ...
            this.each(function () {
                if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                    case "nested":
                        ...
                        d(this.p.data).each(function () {if (parseInt(this[g], 10) === l - 1 && parseInt(this[b], 10) < h && parseInt(this[e], 10) > f)return c = this, !1});
                        break;
                    case "adjacency":
                        var j = this.p.treeReader.parent_id_field, i = this.p.localReader.id;
                        d(this.p.data).each(function () {if (this[i] == a[j])return c = this, !1})
                }
            });
            return c
        },
        getNodeChildren: function (a) {
            ...
            this.each(function () {
                if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                    ...
                    case "adjacency":
                        var j = this.p.treeReader.parent_id_field, i = this.p.localReader.id;
                        d(this.p.data).each(function () {this[j] == a[i] && c.push(this)})
                }
            });
            return c
        },
            ...
            this.each(function () {
                ...
                if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                    case "nested":
                        ...
                        d(this.p.data).each(function () {parseInt(this[h], 10) >= j && (parseInt(this[e], 10) >= f && parseInt(this[e], 10) <= l) && c.push(this)});
                        break;
                    case "adjacency":
                        if (a) {
                            c.push(a);
        ...
        getNodeAncestors: function (a) {
            var c =
                [];
            this.each(function () {if (this.grid && this.p.treeGrid)for (var b = d(this).jqGrid("getNodeParent", a); b;)c.push(b), b = d(this).jqGrid("getNodeParent", b)});
            return c
        },
                ...
                var d = this, b = function (a, b) {
                    ...
                    if (xmlJsonClass.xml2json && c.jgrid.parse) {
                        ...
                        h ? (h = e.grid.datatype,
                             e
                    .
                        grid.datatype = "xmlstring", e.grid.datastr = a, c(d).jqGrid(f).jqGrid("setGridParam", {datatype: h})
                    ):
                        c(d).jqGrid(f)
                ...
                switch (a.imptype) {
                    case "xml":
                        c.ajax(c.extend({
                            ...
                            data: a.impData,
                            dataType: "xml",
                            complete: function (f, g) {"success" == g && (b(f.responseXML, a), c(d).triggerHandler("jqGridImportComplete", [f, a]), c.isFunction(a.importComplete) && a.importComplete(f))}
                        }, a.ajaxOptions));
                        break;
                    case "xmlstring":
                    ...
                    case "json":
                        c.ajax(c.extend({
                            ...
                            data: a.impData,
                            dataType: "json",
                            complete: function (b) {try {g(b.responseText, a), c(d).triggerHandler("jqGridImportComplete", [b, a]), c.isFunction(a.importComplete) && a.importComplete(b)} catch (f) {}}
                        }, a.ajaxOptions));
                        break;
                    case "jsonstring":
    ...
    toObj: function (a) {
        ...
        if (1 === a.nodeType) {
            ...
            if (a.firstChild) {
                ...
                if (e)if (1 < e)b = this.escape(this.innerXml(a)); else for (c = a.firstChild; c; c = c.nextSibling)if (g.test(a.firstChild.nodeValue)) {
...
(function (b) {
    b.browser.msie && 8 == b.browser.version && (b.expr[":"].hidden = function (b) {return 0 === b.offsetWidth || 0 === b.offsetHeight || "none" == b.style.display});
        ...
        if (b.ui.multiselect.prototype._setSelected) {
            ...
            b.ui.multiselect.prototype._setSelected = function (a, e) {
                ...
                if (e && this.selectedList) {
                    var d = this.element;
                    this.selectedList.find("li").each(function () {b(this).data("optionLink") && b(this).data("optionLink").remove().appendTo(d)})
                }
                return c
            }
        }
    ...
    b.jgrid.extend({
        sortableColumns: function (a) {
            return this.each(function () {
                function e() {c.p.disableClick = true}
                ...
                var c = this, d = b.jgrid.jqID(c.p.id), d = {
                    ...
                    placeholder: {
                        element: function (a) {return b(document.createElement(a[0].nodeName)).addClass(a[0].className + " ui-sortable-placeholder ui-state-highlight").removeClass("ui-sortable-helper")[0]},
                        update: function (b, a) {
                    ...
                    update: function (a,
                        ...
                        b.each(c.p.colModel, function (b) {e[this.name] = b});
                        var h = [];
                        d.each(function () {
            ...
            function e(a, c) {a && (typeof a == "string" ? b.fn[a] && b.fn[a].apply(c, b.makeArray(arguments).slice(2)) : b.isFunction(a) && a.apply(c, b.makeArray(arguments).slice(2)))}
            ...
            if (!b("#colchooser_" + b.jgrid.jqID(c[0].p.id)).length) {
                var d = b('<div id="colchooser_' + c[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'),
                    g = b("select", d), a = b.extend({
                        ...
                        height: 240,
                        classname: null,
                        done: function (b) {b && c.jqGrid("remapColumns", b, true)},
                        msel: "multiselect",
                        dlog: "dialog",
                        ...
                        dlog_opts: function (a) {
                            ...
                            c[a.bCancel] = function () {a.cleanup(true)};
                            return b.extend(true, {
                                buttons: c,
                                close: function () {a.cleanup(true)},
                        ...
                        apply_perm: function () {
                            b("option",
                                g).each(function () {this.selected ? c.jqGrid("showCol", k[this.value].name) : c.jqGrid("hideCol", k[this.value].name)});
                            var d = [];
                            b("option:selected", g).each(function () {d.push(parseInt(this.value, 10))});
                            b.each(d, function () {delete f[k[parseInt(this, 10)].name]});
                            b.each(f, function () {
            ...
            return this.each(function () {
                ...
                if (e.grid && !e.p.treeGrid && b.fn.sortable) {
                    ...
                    a.start = function (c, d) {
                        ...
                        b("td", d.item).each(function (b) {this.style.width = e.grid.cols[b].style.width});
                        if (e.p.subGrid) {
                            var g = b(d.item).attr("id");
                            try {b(e).jqGrid("collapseSubGridRow", g)} catch (k) {}
                        }
                        a._start_ && a._start_.apply(this, [c, d])
                    };
                    a.update = function (c, d) {
                        b(d.item).css("border-width", "");
                        e.p.rownumbers === true && b("td.jqgrid-rownum", e.rows).each(function (a) {b(this).html(a + 1 + (parseInt(e.p.page, 10) - 1) * parseInt(e.p.rowNum, 10))});
                ...
                if (c.grid && !c.p.treeGrid && b.fn.draggable && b.fn.droppable) {
                    ...
                    if (typeof a == "string" && a == "updateDnD" && c.p.jqgdnd === true)e(); else {
                                ...
                                return b.extend({
                                    start: function (d, e) {
                                        if (c.p.subGrid) {
                                            ...
                                            try {b(c).jqGrid("collapseSubGridRow", f)} catch (j) {}
                                        }
                                        for (f =
                                        ...
                                        b("td", e.helper).each(function (b) {this.style.width = c.grid.headers[b].width + "px"});
                        ...
                        if (a.connectWith) {
                            ...
                            a.connectWith = b.map(a.connectWith, function (a) {return b.trim(a)});
                            b.data(c, "dnd", a);
